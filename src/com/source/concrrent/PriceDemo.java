...
import com.source.concrrent.test.Shop;
...
public class PriceDemo {
  ...
  public PriceDemo() {
    shops =  Arrays.asList(new Shop("shop1"),
        new Shop("shop2"),
        new Shop("shop3"),
        new Shop("shop4"),
        new Shop("shop5"),
...
//	}
  ...
  public List<String> findPriceExecutorsCompletableFuture(String product){
    ...
    List<CompletableFuture<String>> priceFuture = (List<CompletableFuture<String>>) shops.stream()
        .map(shop -> CompletableFuture
